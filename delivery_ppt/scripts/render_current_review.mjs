  ...
  if (s.type === "product") return `${title(s)}
    <div class="foundation-board">
      ...
      <section class="foundation-flow" aria-label="Product foundation flow">
        ${[
          ["Market", "Discover movement", "chart"],
          ["Portfolio", "Connect holdings", "pie"],
          ["Assistant", "Explain rationale", "chat"],
          ["Products", "Compare terms", "layers"],
        ].map(([head, text, icon], i) => `<article class="flow-step">
      ...
      <section class="foundation-rules2">
        ...
        ${[
          ["Evidence first", "Show proof before interpretation.", "shield"],
          ["Progressive depth", "Cards open focused pages.", "route"],
          ["Role clarity", "Separate user and admin paths.", "user"],
          ["Clear boundary", "No order or advice flow.", "lock"],
...
function css() {
  return `<style>
    ...
    *{box-sizing:border-box}
    ...
    .foundation-board{width:1160px;height:610px;display:grid;grid-template-columns:320px 1fr 340px;gap:24px;align-items:stretch}.foundation-thesis2{background:#fff;border:1px solid #d7dce3;border-left:6px solid #91A3B8;padding:30px 30px 28px;display:flex;flex-direction:column}.foundation-thesis2 h2{font-size:42px;line-height:1.04;margin:28px 0 20px;color:#121923}.foundation-thesis2 p{font-size:19px;line-height:1.34;margin:22px 0 0;color:#455260}.thesis-meter{margin-top:auto;border-top:1px solid #e2e6eb;border-bottom:1px solid #e2e6eb;padding:22px 0;display:grid;grid-template-columns:1fr;gap:14px}.thesis-meter div{display:grid;grid-template-columns:46px 1fr;gap:14px;align-items:center}.thesis-meter svg{width:26px;height:26px;fill:none;stroke:#7e6f48;stroke-width:2.4;stroke-linecap:round;stroke-linejoin:round}.thesis-meter div:before{content:"";width:46px;height:46px;border-radius:16px;background:#f8f8f5;border:1px solid #ded8c8;grid-column:1;grid-row:1}.thesis-meter div svg{grid-column:1;grid-row:1;margin:auto;z-index:1}.thesis-meter b{font-size:16px;text-transform:uppercase;letter-spacing:.08em;color:#2f3a47}.foundation-flow{position:relative;background:#fbfcfd;border:1px solid #d7dce3;padding:34px 34px;display:grid;grid-template-columns:1fr 1fr;gap:22px}.foundation-flow:before{content:"";position:absolute;left:50%;top:92px;bottom:92px;border-left:1px dashed #b7c0ca}.foundation-flow:after{content:"";position:absolute;left:92px;right:92px;top:50%;border-top:1px dashed #b7c0ca}.flow-step{position:relative;background:#fff;border:1px solid #d7dce3;padding:22px;min-height:225px;display:flex;flex-direction:column;z-index:1}.flow-icon,.foundation-rules2 span{width:54px;height:54px;border-radius:18px;background:#f8f8f5;border:1px solid #ded8c8;display:flex;align-items:center;justify-content:center;color:#7e6f48}.flow-icon svg,.foundation-rules2 svg{width:29px;height:29px;fill:none;stroke:currentColor;stroke-width:2.4;stroke-linecap:round;stroke-linejoin:round}.flow-step span{position:absolute;right:22px;top:23px;font-family:Georgia,serif;font-size:30px;color:#b9a46d}.flow-step b{font-size:25px;margin-top:auto;color:#121923}.flow-step p{font-size:15px;line-height:1.25;margin:9px 0 0;color:#566170}.foundation-rules2{background:#fff;border:1px solid #d7dce3;padding:28px 28px;display:grid;grid-template-rows:auto repeat(4,1fr);gap:14px}.foundation-rules2 label{margin-bottom:0}.foundation-rules2 div{display:grid;grid-template-columns:58px 1fr;grid-template-rows:auto auto;column-gap:14px;align-items:start;border-bottom:1px solid #e1e5ea;padding-bottom:13px}.foundation-rules2 div:last-child{border-bottom:0}.foundation-rules2 span{grid-row:1 / span 2}.foundation-rules2 b{font-size:18px;line-height:1.08;color:#17202b}.foundation-rules2 p{font-size:13.8px;line-height:1.26;margin:6px 0 0;color:#566170}.product-foundation,.pilot-scope,.foundation-hero,.foundation-orbit,.foundation-rules{display:none}
