...
| --- | --- | --- | --- |
| [US-ADM-01](#user-story-1---通过-admin-portal-维护并核验客户端内容) | Admin Functional Acceptance | Dashboard + ETF Catalogue + Model Portfolios + operational visibility | [视频](https://jjpvro70sief.jp.larksuite.com/wiki/BBmUwLwV0iRRxdkl3S9jV9ZHpLe?from=from_copylink) |
